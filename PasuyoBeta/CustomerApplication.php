<?php
	...
	if(isset($_POST['activate'])){
		$id = $_POST['custid'];
		ActivateCustomer($database,$id);
	}
	if(isset($_POST['deactivate'])){
		$id = $_POST['custid'];
		DeactivateCustomer($database,$id);
	}
	if(isset($_POST['update'])){
		...
		UpdateCustomerInfo($database,$id,$name,$city,$contact);
	}
...
<body>
	...
	<table>
		<tr>
			...
			<?php
				DisplayCustomersINCustomerApplication($database);
			?>
